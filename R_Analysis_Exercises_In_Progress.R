...
# Get end the time of the "End of Task" event. Get the end time of the "Deompgraphic questions"
# event (the last event before the task started). Compute the difference between the two. Convert
# from milliseconds to seconds and from seconds to minutes.
...
# Retrieve participants' answer to the question "QC" (quality check). Check how many of them
# respneded (correctly) with "Chicago".
